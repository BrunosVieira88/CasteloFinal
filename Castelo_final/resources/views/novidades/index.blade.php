    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <div style="width: 99%;" class="card">
                    <div class="col-md-12 text-center">
                        <img src="img/arthur o ataque ao ministerio.png" style="width: 80vh;height:50vh;margin:auto;border-radius:50%"  class="img-fluid paraimagem fade-out mt-5" alt="">
                    </div>
                    <div class="p-5">
            ...
            <div class="col-md-6 text-center card">
                <div style="width: 99%;" >
                    <div class="col-md-12">
                        <img src="img/MatrizInvertida.png" style="width: 80vh;height:50vh;margin:auto;" class="img-fluid d-flex align-content-center mt-5" alt="">
                    </div>
                    <div class="p-5">
