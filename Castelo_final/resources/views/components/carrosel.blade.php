...
<div class="row aparece mt-4" id="grande">
    <div class="col-12">
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner carousel-container">
          <div class="carousel-item active">
            <img src="img/PersonagensReunidos.png" class="d-block" alt="...">
          ...
          <div class="carousel-item">
            <img src="img/CMB.png" class="d-block" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="img/CasteloBruxo.png" class="d-block" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="img/Times.png" class="d-block" alt="...">
            <div class="carousel-caption d-none d-md-block">
