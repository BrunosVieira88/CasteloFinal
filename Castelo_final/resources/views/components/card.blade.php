...
<div class="row " id="pequeno">
    <div class="col-md-3  mt-2 mr-2">
      <div class="p-3 card leader-cardhome-card">
        ...
        <a href="{{ $primeiroLink }}" class=" text-center" ><button class="btn btn-primary"></button></a>
      </div>
    </div>
    <div class="col-md-3  mt-2">
      <div class="p-3 card leader-cardhome-card">
        ...
        <a href="{{ $segundoLink }}" class="text-center"><button class="btn btn-primary">SAIBA MAIS</button></a>
    ...
    <div class="col-md-3  mt-2">
      <div class="p-3 card leader-cardhome-card">
        ...
        <a href="{{ $terceiroLink }}" class="text-center" ><button class="btn btn-primary">SAIBA MAIS</button></a>
    ...
    <div class="col-md-3  mt-2">
      <div class="p-3 card leader-cardhome-card">
        ...
        <a href="{{ $quartoLink }}" class="text-center" ><button class="btn btn-primary">SAIBA MAIS</button></a>
      </div>
    </div>
  </div>
